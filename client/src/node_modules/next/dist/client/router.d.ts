...
export declare const createRouter: (args_0: string, args_1: import("querystring").ParsedUrlQuery, args_2: string, args_3: {
    subscription: (data: import("next/dist/next-server/lib/router/router").PrivateRouteInfo, App: import("next/dist/next-server/lib/router/router").AppComponent, resetScroll: {
        x: number;
        y: number;
    } | null) => Promise<void>;
    initialProps: any;
    ...
    App: import("next/dist/next-server/lib/router/router").AppComponent;
    wrapApp: (WrapAppComponent: import("next/dist/next-server/lib/router/router").AppComponent) => any;
    err?: Error | undefined;
    isFallback: boolean;
